    ...
    public static Polinomio sumar(Polinomio pol1, Polinomio pol2) {
        ...
        while (recorrido1 != null && recorrido2 != null) {
            if (recorrido1.getTermino().getExp() > recorrido2.getTermino().getExp()) {
                ...
                /*
                 * *Hago SetLiga Creando un nuevo nodo, con un nuevo termino y le asigno exp y
                 * coef
                 */
                ultimo3.setLiga(
                        new Nodo(new Termino(recorrido1.getTermino().getCoef(), recorrido1.getTermino().getExp())));
                 ...
                 */
                ultimo3.setLiga(
                        new Nodo(new Termino(recorrido2.getTermino().getCoef(), recorrido2.getTermino().getExp())));
                ultimo3 = ultimo3.getLiga();
                ...
                if ((recorrido1.getTermino().getCoef() + recorrido2.getTermino().getCoef()) != 0) {
                     ...
                     */
                    ultimo3.setLiga(
                            new Nodo(new Termino(recorrido1.getTermino().getCoef() + recorrido2.getTermino().getCoef(),
